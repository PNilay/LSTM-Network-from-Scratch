...
![Before trainning output](https://github.com/PNilay/LSTM-Network-from-Scratch/blob/main/Text%20Generation/textgen_before.png "Before Trainning")

#### After Trainning Output of the LSTM text generation model
![alt-text-2](https://github.com/PNilay/LSTM-Network-from-Scratch/blob/main/Text%20Generation/textgen_before.png "After Trainning")
